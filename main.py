...
def extract_otp_from_text(text):
    """Har tarah ke OTP ko dhundhne ke liye - FB-07670, code:123456, etc."""
    if not text:
        return None
    text = html.unescape(text)
    
    # Pattern 1: FB-07670 ya FB07670
...
def confirm_account_with_auto_otp(session, email_address, max_retries=3):
    for attempt in range(max_retries):
        ...
        if otp_code:
            ...
            # IMPORTANT: OTP code return kar raha hai
...
# ============ TELEGRAM BOT KE LIYE REGISTER ACCOUNT FUNCTION - OTP SHOW FIXED ============
