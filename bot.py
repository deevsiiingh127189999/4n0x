        ...
        while True:
            ...
            if result and isinstance(result, dict) and result.get("uid"):
                async with lock:
                    ...
                    otp_value = result.get("otp_fetched", "NO_OTP_SENT")
...
async def main():
    ...
    print("🔐 OTP: Auto-fetched from Yandex (if sent by Facebook)")
